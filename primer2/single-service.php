                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="page-head-left">
                        ...
                        <div class="single-page-head">
                            <div class="left-menu">
                                <ul>
                                    <li class="active"><a href="#">Residential Cleaning</a></li>
                            ...
                            <div class="clients-support">
                                <div class="support-img">
                                    ...
                                    <div class="support-text">
                                        ...
                                        <a><i class="icon icon-phone"></i>+1313-5454652</a>
                ...
                <div class="col-md-9 col-sm-8 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="single-well">
                                ...
                                <p>When replacing a multi-lined selection of text, the generated dummy text maintains the amount of lines. When replacing a selection of text within a single line, the amount of words is roughly being maintained.When the replaced
                                    text selection consists fully of lower-cased or capital letters or begins with a capital letter, that previous casing is maintained. Furthermore, the presence or absence of a trailing punctuation mark of a replaced
                                    text selection is being maintained.</p>
                            </div>
                        </div>
                    </div>
                    <!-- end Row -->
                    <div class="row mar-row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="single-well">
                                <a href="#">
                                    <h4>How to cleaning perfectly</h4>
                                </a>
