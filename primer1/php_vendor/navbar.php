    ...
    <div id="wrapper" class="wrapper">
        ...
        <header class="header">
            ...
            <div id="header-menu" class="header-menu menu-layout1">
                <div class="container">
                    <div class="row d-flex align-items-center justify-item-center">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-area">
                                <a href="index.php" class="temp-logo">
                                    <h1 style="font-size: 21px;">Company Logo</h1>
                                    <!--
                                    ...
                                    <li class="position-static hide-on-mobile-menu">
                                        ...
                                        <div class="template-mega-menu">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-3">
                                                        <div class="menu-ctg-title">Projects</div>
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="project1.php">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="menu-ctg-title">Team</div>
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="team1.php">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="calculate-form.php">
                                                                    <i class="fas fa-calculator"></i>Calculation Form</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-3">
                                                        <div class="menu-ctg-title">Additional pages</div>
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="404.php">
