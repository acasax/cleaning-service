...
<body class="sticky-header">
    ...
    ?>
                ...
                <div class="row gutters-50 d-flex align-items-center">
                    ...
                    <div class="col-xl-5">
                        <div class="about-box-layout4">
                            ...
                            <p>Spa isa newsimply dummy text of the printing and type settingare industrLorem Ipsum has been the industry's standard dummy text everty since the when an unknown centuries, but also the leap into electronic typesetting, remaining
                                essentially.
                            </p>
        ...
        <section class="section-padding-lg bg-common bg-aash" data-bg-image="img/figure/bg-shape1.png">
            <div class="container">
        ...
        <section class="section-padding-xl bg-Primary section-shape2">
            <div class="container">
                <div class="heading-layout1 mg-b-60">
                    ...
                    <p class="text-textprimary">Perspiciatis unde omnis iste natus error sit voluptatem accusantium dol oremque laudantium, totam remeaque ipsa</p>
                </div>
                <div class="row">
                    <div class="col-lg-4">
        ...
        <section class="section-padding-md-4 bg-Primary bg-common" data-bg-image="img/figure/bg-shape.png">
            <div class="container">
                ...
                <div class="rc-carousel nav-control-layout1" data-loop="true" data-items="10" data-margin="30" data-autoplay="false" data-autoplay-timeout="3000" data-smart-speed="1000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="true"
                    data-r-x-small-dots="false" data-r-x-medium="1" data-r-x-medium-nav="true" data-r-x-medium-dots="false" data-r-small="1" data-r-small-nav="true" data-r-small-dots="false" data-r-medium="2" data-r-medium-nav="true" data-r-medium-dots="false"
                    data-r-large="3" data-r-large-nav="true" data-r-large-dots="false" data-r-extra-large="3" data-r-extra-large-nav="true" data-r-extra-large-dots="false">
                    <div class="testimonial-box-layout1">
                        <p>Wimply dummy text of the printing and typesetting industryrem Ipsum has been the industry's standard dummy text ever since </p>
        ...
        <section class="section-padding-lg-4 section-bubble">
            <div class="container">
                <div class="heading-layout1">
                    ...
                    <p>Perspiciatis unde omnis iste natus error sit voluptatem accusantium fa-angle-double-up oremque laudantium, totam remeaque ipsa</p>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-12">
                            <div class="footer-newsletter">
                                <h3 class="item-title">Sign up for news and special offers</h3>
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="footer-social">
                                <h4 class="item-title">Follow Us On :</h4>
